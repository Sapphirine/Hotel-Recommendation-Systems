...
(window.jQuery), ! function(a) {
    var b = function(b, c) {
        this.$element = a(b), this.options = a.extend({}, a.fn.collapse1.defaults, c), this.options.parent && (this.$parent = a(this.options.parent)), this.options.toggle && this.toggle()
    };
    b.prototype = {
        constructor: b,
        dimension: function() {
        ...
        show: function() {
            ...
            if (d && d.length) {
                e = d.data("collapse1");
                if (e && e.transitioning) return;
                d.collapse1("hide"), e || d.data("collapse1", null)
            }
            this.$element[b](0), this.transition("addClass", a.Event("show"), "shown"), a.support.transition && this.$element[b](this.$element[0][c])
        },
        hide: function() {
        ...
        reset: function(a) {
            var b = this.dimension();
            return this.$element.removeClass("collapse1")[b](a || "auto")[0].offsetWidth, this.$element[a !== null ? "addClass" : "removeClass"]("collapse1"), this
        },
        transition: function(b, c, d) {
            var e = this,
                f = function() {
            ...
            this.$element.trigger(c);
            if (c.isDefaultPrevented()) return;
            this.transitioning = 1, this.$element[b]("in"), a.support.transition && this.$element.hasClass("collapse1") ? this.$element.one(a.support.transition.end, f) : f()
        },
        toggle: function() {
            this[this.$element.hasClass("in") ? "hide" : "show"]()
        }
    };
    var c = a.fn.collapse1;
    a.fn.collapse1 = function(c) {
        return this.each(function() {
            var d = a(this),
                e = d.data("collapse1"),
                f = typeof c == "object" && c;
            e || d.data("collapse1", e = new b(this, f)), typeof c == "string" && e[c]()
        })
    }, a.fn.collapse1.defaults = {
        toggle: !0
    }, a.fn.collapse1.Constructor = b, a.fn.collapse1.noConflict = function() {
        return a.fn.collapse1 = c, this
    }, a(document).on("click.collapse1.data-api", "[data-toggle=collapse1]", function(b) {
        var c = a(this),
            d, e = c.attr("data-target") || b.preventDefault() || (d = c.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, ""),
            f = a(e).data("collapse1") ? "toggle" : c.data();
        c[a(e).hasClass("in") ? "addClass" : "removeClass"]("collapsed1"), a(e).collapse1(f)
    })
}/*_________________________________________________________________________*/
(window.jQuery), ! function(a) {
    var b = function(b, c) {
